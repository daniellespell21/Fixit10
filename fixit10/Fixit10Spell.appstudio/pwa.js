...
const cacheName = 'Fixit10Spell-2020-10-25 17:37:33.426156'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit10Spell'.length) === 'Fixit10Spell') {
